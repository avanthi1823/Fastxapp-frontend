// src/pages/dashboards/OperatorDashboard.jsx
import React, { useEffect, useMemo, useState } from "react";
import operatorService from "../../services/operatorService"; // operator APIs
import adminService from "../../services/adminService"; // admin APIs for routes
...
export default function OperatorDashboard() {
  ...
  <AddRouteModal
    ...
    onAdded={loadAll}       // <-- refresh routes
  />
)}
...
{editRoute && (
  <EditRouteModal
    ...
    onUpdated={loadAll}     // <-- refresh routes
  />
)}
